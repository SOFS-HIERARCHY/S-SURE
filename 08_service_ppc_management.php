...
<!-- Mirrored from cdn1.crumina.net/html-seosight/08_service_ppc_management.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Dec 2016 07:30:46 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head lang="en">
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    <title>Seosight - Case Studies</title>
                    ...
                    <ul class="list list--secondary">
                        <li>
                            ...
                            <a href="#">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy
                                nibh euismod tincidunt ut laoreet dolore wisi enim ad minim veniam;</a>
                        </li>
                        <li>
                            <i class="seoicon-check"></i>
                            <a href="#">Mirum est notare quam littera gothica, quam nunc putamus parum,
                                anteposuerit litterarum formas duis dolore.</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="info-box--standard">
                ...
                <div class="info-box-content">
                    ...
                    <p class="text">Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium
                        lectorum investigationes demonstraverunt.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="info-box--standard">
                ...
                <div class="info-box-content">
                    ...
                    <p class="text">Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="info-box--standard">
                ...
                <div class="info-box-content">
                    ...
                    <p class="text">Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet
...
<div class="container">
    ...
    <div class="recent-case-slider medium-padding120">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="heading">
                    <h4 class="h1 heading-title">Our Case Studies</h4>
                    <a href="11_case_studies.php" class="read-more">See All Projects
                        <i class="seoicon-right-arrow"></i>
                    </a>
                    <div class="heading-line">
                        <span class="short-line"></span>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-12 col-xs-12">
                    <div class="testimonial-slider-standard align-center medium-padding120">
                        ...
                        <div class="swiper-container pagination-bottom">
                            ...
                            <div class="testimonial-item">
                                ...
                                <div class="testimonial-text c-dark">
                                    Mirum est notare quam littera gothica, quam nunc putamus parum claram,
                                    anteposuerit litterarum formas humanitatis seacula.
                                </div>

                                <div class="author-info-wrap display-flex content-center">
                                    <div class="testimonial-img-author f-left">
                                        <img src="img/avatar.png" alt="author">
                                    </div>
                                    <div class="author-info">
                                        <h4 class="author-name">Jonathan Simpson</h4>
                                        <div class="author-company">Envato Market</div>
                                    </div>

                                    <div class="btn-next btn-prev-black"></div>
                                    <div class="btn-prev btn-next-black"></div>
                                </div>
                            </div>
                        </div>
                                <div class="testimonial-slider-standard-item swiper-slide">
...
<div class="container">
    <div class="row medium-padding120">
        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
            ...
            <a href="09_our_clients.php" class="btn btn-medium btn--dark mb30">
            ...
            <div class="row">
                <div class="clients-item-wrap">
                    ...
                    <div class="client-item mb60">
                        <a href="09_our_clients.php" class="client-image">
