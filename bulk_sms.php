...
<div class="stunning-header stunning-header-bg-green">
    <div class="stunning-header-content">
        <h1 class="stunning-header-title">Bulk SMS & E-Marketing</h1>
        <ul class="breadcrumbs">
            ...
            <li class="breadcrumbs-item active">
                <span href="#">Bulk SMS & E-Marketing</span>
                <i class="seoicon-right-arrow"></i>
            </li>
        </ul>
    </div>
    ...
    <div class="row bg-border-color medium-padding120">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="heading">
                        <h4 class="h1 heading-title">Bulk SMS & E-Marketing</h4>
    ...
    <div class="row pt120 mb30">
        ...
        <div class="col-lg-12">
            <div class="heading align-center">
                ...
                <p class="heading-text">SMS marketing can increase & improve engagement or communication with your customers. It is an effective, fast and reliable way to connect with your customers.</p>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-sx-12">
                    <div class="info-box--standard">
                        ...
                        <div class="info-box-content">
                            <p class="text">Enable 2-factor security/authentication in 2 minutes.</p>
                        </div>
                    </div>
                </div>
