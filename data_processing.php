            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="heading">
                        ...
                        <p class="heading-text">Data processing is, generally, "the collection and manipulation of items of data to produce meaningful information." It can be considered a subset of information processing, "the change of information in any manner detectable by an observer."</p>
                    ...
                    <ul class="list list--secondary">
                        <li>
                            ...
                            <a href="#">Data processing is a set of methods that are used to input, retrieve, verify, store, organize, analyse or interpret a set of data. </a>
                        </li>
                        <li>
                            <i class="seoicon-check"></i>
                            <a href="#">Data processing enables information to be automatically extracted from data, and could be used in computational biology and bioinformatics to organise a large set of 'omics data.</a>
                        </li>
                    </ul>
                </div>
            </div>
