...
<head lang="en">
    ...
    <title>SOFS Technologies - Salem, Tamil Nadu, India</title>
    ...
    <div class="container-full-width">
            <div class="swiper-container main-slider" data-effect="fade" data-autoplay="4000">
                ...
                <div class="swiper-wrapper">
                    <!-- Slides -->
                    <div class="swiper-slide bg-white-color main-slider-bg-dark">
                            ...
                            <div class="row table-cell">
                                ...
                                <div class="col-lg-6 table-cell">
                                    <div class="slider-content">
                                        ...
                                        <h5 class="slider-content-text c-gray" data-swiper-parallax="-200">Mark your presence on the world wide web, with our innovative website design and web development services.
                                         </h5>
                            ...
                            <div class="row table-cell">
                                <div class="col-lg-6 table-cell">
                                    ...
                                    <div class="slider-content">
                                        ...
                                        <h3 class="h1 slider-content-title c-dark" data-swiper-parallax="-100">Mobile App Development
                                        </h3>

                                        <h5 class="slider-content-text" data-swiper-parallax="-200">To enhance interactive communications with customers & clients with the help of Mobile Apps Development.
                                        </h5>

                                        <div class="main-slider-btn-wrap" data-swiper-parallax="-300">

                                            <a href="mobile_app.php" class="btn btn-medium btn--dark btn-hover-shadow">
                                                <span class="text">learn more</span>
                                                <span class="semicircle"></span>
                                            </a>
                            ...
                            <div class="row table-cell">
                                ...
                                <div class="col-lg-6 table-cell">
                                    <div class="slider-content">
                                        ...
                                        <h3 class="h1 slider-content-title c-dark" data-swiper-parallax="-100">Bulk SMS &
                                         E-Marketing
                                        </h3>
                                ...
                                <div class="col-lg-6 table-cell">
                                    <div class="slider-thumb" data-swiper-parallax="-300" data-swiper-parallax-duration="500">
                                        <img src="img/slider6.png" alt="slider">
                                    </div>
                                </div>
                ...
                <div class="slider-slides">
                    ...
                    <a href="#" class="slides-item bg-primary-color">
                        <div class="content">
                            <div class="text-wrap">
                                <h4 class="slides-title">Software Development</h4>
                                </div>
                    ...
                    <a href="#" class="slides-item bg-secondary-color">
                        <div class="content">
                            <div class="text-wrap">
                                <h4 class="slides-title">Mobile App Developmet</h4>
                            </div>
                    ...
                    <a href="#" class="slides-item bg-orange-color">
                        <div class="content">
                            <div class="text-wrap">
                                <h4 class="slides-title">Bulk SMS & E-Marketing</h4>
                            </div>
            ...
            <div class="offers">
                <div class="row">
                    <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                        <div class="heading">
                            <h4 class="h1 heading-title">Bulk SMS</h4>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <div class="heading">
                            <p class="heading-text">SMS marketing can increase & improve engagement or communication with your customers. It is an effective, fast and reliable way to connect with your customers.
                            </p>
                        </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-12 col-xs-12">
                        <div class="heading align-center">
                            <h4 class="h1 heading-title">Our Recent Projects</h4>
                            <div class="heading-line">
                                <span class="short-line"></span>
                                <span class="long-line"></span>
                            </div>
                    ...
                    <div class="case-item-wrap">
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="case-item">
                                ...
                                <h6 class="case-item__title"><a href="#">Fresh farm supermarkets</a></h6>
                            </div>
                        </div>
                ...
                <a href="portfolio.php" class="btn btn-medium btn--dark">
