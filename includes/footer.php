        ...
        <div class="row">
            ...
            <div class="info">
                <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                    <div class="heading">
                        <h3 class="heading-title">SOFS Technologies & Services!</h3>
                        <div class="heading-line">
                            <span class="short-line"></span>
                            <span class="long-line"></span>
                        </div>
                        <p class="heading-text">SOFS, a new emerging software development company providing software and business solutions that partners with its clients to simplify, strengthen and transform their businesses by implementing innovative ideas. At SOFS, we know we need a good understanding of your company organization to offer you top-quality, efficient IT solutions that evolve with your company's needs. We can offer you individualized software solutions on any scale because we know how to utilize the powers of different technologies and integrate them seamlessly.
                        </p>
                    </div>
            ...
            <div class="contacts">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a class="title">Salem, India</a>
                            <p class="sub-title">Advaitha Ashramam Road</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <span>
                        Copyright © 2017 <a href="home.php" class="sub-footer__link">SOFS</a>
                      </span>
