...
<html lang="en">
    ...
    <title>SOFS Technologies - Services</title>
    ...
    <div class="row pt120 pb30">
        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
            <div class="services-main">
                <div class="heading">
                    <h4 class="h1 heading-title">Full Services of Your Trusted Partner</h4>
                    <div class="heading-line">
                        <span class="short-line"></span>
                        <span class="long-line"></span>
                    </div>
                    <p class="heading-text">Choosing SOFS offers your company a professional and experienced partner. The top priority at SOFS is customer service. we are proud to have been providing Software Development Outsourcing and IT Consulting using best practices.
                    </p>
                </div>
    ...
    <div class="row pb120">
        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
            <div class="servises-item bg-secondary-color">
                ...
                <div class="servises-item__content">
                    <h4 class="servises-title">Mobile App Development</h4>
                    <p class="servises-text">We build mobile solutions improving your business effectiveness and efficiency. With long experience, we have a strong knowledge base to guide you along the process of mobile application development in all platforms.
                    </p>
                </div>
