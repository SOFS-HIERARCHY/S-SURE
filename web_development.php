        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <img src="img/slider2.png" alt="PPC">
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="heading">
                        ...
                        <p class="heading-text">Sofs creates attractive, appropriate and usable designs which engage your audience and ensure an effective transmission of your message. With a strong
                    emphasis on making websites intuitive and easy to use, we use our extensive in_house graphic design skills to produce cutting edge multimedia application and websites.
